...
(function webpackUniversalModuleDefinition(root, factory) {
	...
	else if (typeof exports === "object") exports["functionalLight"] = factory();
	else root["functionalLight"] = factory();
 ...
 */
				...
				function isList(list) {
					return (
						typeof list === "object" && typeof list.length == "number" && list.length >= 0
					);
				}
				/**
